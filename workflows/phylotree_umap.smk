...
#odog_n    = [150]
#odog_m    = [0.75]
# odog_size is now a list of integers representing sentinel values for missing data
# Common values: 0 (small), 999999999999 (large), or any other integer
odog_size = [999999999999]
...
#odol_n    = [10]
#odol_m    = [0.9]
# odol_size is now a list of integers representing sentinel values for missing data
odol_size = [999999999999]
...
# codog_size is now a list of integers representing sentinel values for missing data
codog_size = [999999999999]
