...
from ete4 import Tree, TreeStyle, AttrFace, faces, NodeStyle, NCBITaxa
...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(
        description="Render a phylogenetic tree (newick) as a cladogram, collapsing class-level clades.",
    )
    parser.add_argument("newick", help="Path to a newick tree file (node names are NCBI taxids).")
